...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train StrBuild with GRPO (CoMLRL MAGRPOTrainer num_agents=1)")
    parser.add_argument(
        "--config",
        type=str,
        default=os.path.join(REPO_ROOT, "str_build", "configs", "str_build_magrpo_config.yaml"),
